...
`;
  ...
  createVideo() {
    ...
    control.innerHTML = `
      ...
      <div class="trangle-1" style="${this.trangle1Style + ' ' + this.trangleStyle}"></div>
      <div class="trangle-2" style="${this.trangle2Style + ' ' + this.trangleStyle}"></div>
    `;
  ...
  onDragClick(e) {
    ...
    if(this.musicbarEle.style.transform) {
      const translate = this.musicbarEle.style.transform.replace('translate3d(', '').replace(')', '').split(', ');
